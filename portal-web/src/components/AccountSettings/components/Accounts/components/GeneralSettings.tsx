...
import { IGeneralSettings } from "../Accounts.type"
import styles from "../Accounts.module.scss"
import { CountryCodes, Voices, timeZones } from "../../../../shared/Countries"
...
import { GeneralSettingsCommonRow } from "./GeneralSettingsRow"

type OwnProps = {
  gSettings: IGeneralSettings
...
export const GeneralSettings: React.FC<OwnProps> = ({
  ...
  const [gSettingsState, setGSettingsState] = useState<IGeneralSettings>({
  ...
  const [updateSettings, { loading: updateLoading }] = useMutation(
    ...
    {
      onCompleted(data) {
        const { message } = data.updateGeneralSettings
  ...
  const [deleteSettings, { loading: deleteLoading }] = useMutation(
    ...
    {
      onCompleted(data) {
        const { message } = data.deleteGeneralSettings
        handleOnComplete(message)
      },
    },
  )
